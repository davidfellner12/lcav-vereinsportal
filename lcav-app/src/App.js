...
import TrainingsplanKalender from './pages/TrainingsplanKalender';
import AthletenDetail from './pages/AthletenDetail';
...
function AppContent() {
  ...
  const pages = {
    ...
    aufgaben:               <Aufgaben />,
    wettkampf:              <Wettkampf />,
    trainerhub:             <TrainerHub />,
    trainingsplan_kalender: <TrainingsplanKalender />,
    athletendetail:         <AthletenDetail />,
  };
